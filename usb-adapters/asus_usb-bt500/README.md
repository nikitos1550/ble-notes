...
## dmesg
```
[11415.572179] usb 1-1: new full-speed USB device number 32 using xhci_hcd
[11415.725027] usb 1-1: New USB device found, idVendor=0b05, idProduct=190e, bcdDevice= 2.00
[11415.725035] usb 1-1: New USB device strings: Mfr=1, Product=2, SerialNumber=3
[11415.725039] usb 1-1: Product: ASUS USB-BT500
[11415.725042] usb 1-1: Manufacturer: Realtek
[11415.725044] usb 1-1: SerialNumber: 00E04C239987
[11415.734755] Bluetooth: hci1: RTL: examining hci_ver=0a hci_rev=000b lmp_ver=0a lmp_subver=8761
[11415.735749] Bluetooth: hci1: RTL: rom_version status=0 version=1
[11415.735752] Bluetooth: hci1: RTL: loading rtl_bt/rtl8761b_fw.bin
[11415.735872] Bluetooth: hci1: RTL: loading rtl_bt/rtl8761b_config.bin
[11415.735925] Bluetooth: hci1: RTL: cfg_sz 14, total sz 11678
[11415.808764] Bluetooth: hci1: RTL: fw version 0x097bec43
```

## lsusb
```
Bus 001 Device 032: ID 0b05:190e ASUSTek Computer, Inc.
```

## lsusb -t 
```
    |__ Port 1: Dev 32, If 1, Class=Wireless, Driver=btusb, 12M
    |__ Port 1: Dev 32, If 0, Class=Wireless, Driver=btusb, 12M
```
...
hci1:	Type: Primary  Bus: USB
	BD Address: 04:42:1A:5C:01:96  ACL MTU: 1021:6  SCO MTU: 255:12
	Commands: Octet 0  = 0xff (Bit 0 1 2 3 4 5 6 7)
		  ...
		  Octet 8  = 0x3f (Bit 0 1 2 3 4 5)
		  Octet 9  = 0xff (Bit 0 1 2 3 4 5 6 7)
		  Octet 10 = 0xfc (Bit 2 3 4 5 6 7)
	...
	'Read Inquiry Scan Type' 'Write Inquiry Scan Type' 'Read Inquiry Mode' 
	'Write Inquiry Mode' 'Read Page Scan Type' 'Write Page Scan Type' 
...
hci1:	Type: Primary  Bus: USB
	BD Address: 04:42:1A:5C:01:96  ACL MTU: 1021:6  SCO MTU: 255:12
	HCI Version:  (0xa)  Revision: 0x97b
	LMP Version:  (0xa)  Subversion: 0xec43
