...
## dmesg
```
[346812.027539] usb 1-1: new full-speed USB device number 28 using xhci_hcd
[346812.176661] usb 1-1: New USB device found, idVendor=2b89, idProduct=8761, bcdDevice= 2.00
[346812.176667] usb 1-1: New USB device strings: Mfr=1, Product=2, SerialNumber=3
[346812.176671] usb 1-1: Product: Bluetooth Radio
[346812.176675] usb 1-1: Manufacturer: Realtek
[346812.176678] usb 1-1: SerialNumber: 00E04C239987
```

## lsusb
```
Bus 001 Device 028: ID 2b89:8761  
```

## lsusb -t
```
    |__ Port 1: Dev 28, If 1, Class=Wireless, Driver=btusb, 12M
    |__ Port 1: Dev 28, If 0, Class=Wireless, Driver=btusb, 12M
```
...
hci1:	Type: Primary  Bus: USB
	BD Address: 0A:62:30:21:01:0B  ACL MTU: 1021:6  SCO MTU: 255:12
