...
## dmesg
```
[347049.862118] usb 1-1: new full-speed USB device number 29 using xhci_hcd
[347050.019653] usb 1-1: New USB device found, idVendor=10d7, idProduct=b012, bcdDevice=88.91
[347050.019661] usb 1-1: New USB device strings: Mfr=1, Product=2, SerialNumber=3
[347050.019666] usb 1-1: Product: general adapter
[347050.019670] usb 1-1: Manufacturer: Actions
[347050.019674] usb 1-1: SerialNumber: ACTIONS1234
```

## lsusb
```
Bus 001 Device 029: ID 10d7:b012  
```

## lsusb -t
```
    |__ Port 1: Dev 29, If 1, Class=Wireless, Driver=btusb, 12M
    |__ Port 1: Dev 29, If 0, Class=Wireless, Driver=btusb, 12M
```
...
hci1:	Type: Primary  Bus: USB
	BD Address: F4:4E:FC:21:D0:3F  ACL MTU: 679:6  SCO MTU: 240:20
	Commands: Octet 0  = 0xb3 (Bit 0 1 4 5 7)
	...
	'Inquiry' 'Inquiry Cancel' 'Create Connection' 'Disconnect' 
	'Cancel Create Connection' 'Accept Connection Request' 
	...
	'Read Clock Offset' 'Read LMP Handle' 'Sniff Mode' 'Exit Sniff Mode' 
	...
	'Write Automatic Flush Timeout' 'Read Transmit Power Level' 
...
hci1:	Type: Primary  Bus: USB
	BD Address: F4:4E:FC:21:D0:3F  ACL MTU: 679:6  SCO MTU: 240:20
	Features page 0: 0xbf 0xfe 0x0d 0xfe 0xdb 0xfd 0x7b 0x87
