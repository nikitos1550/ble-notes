...
## dmesg
```
[11098.622510] usb 1-1: new full-speed USB device number 30 using xhci_hcd
[11098.778075] usb 1-1: New USB device found, idVendor=0a12, idProduct=0001, bcdDevice=88.91
[11098.778082] usb 1-1: New USB device strings: Mfr=0, Product=0, SerialNumber=0
[11098.781197] Bluetooth: hci1: unexpected event for opcode 0x0000
```
...
## lsusb -t
```
    |__ Port 1: Dev 30, If 1, Class=Wireless, Driver=btusb, 12M
    |__ Port 1: Dev 30, If 0, Class=Wireless, Driver=btusb, 12M
```
