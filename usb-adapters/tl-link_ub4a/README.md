...
## dmesg
```
[10994.831303] usb 1-1: new full-speed USB device number 28 using xhci_hcd
[10994.982440] usb 1-1: New USB device found, idVendor=0a12, idProduct=0001, bcdDevice=88.91
[10994.982446] usb 1-1: New USB device strings: Mfr=0, Product=0, SerialNumber=0
[10994.988043] Bluetooth: hci1: unexpected event for opcode 0x0000
```
